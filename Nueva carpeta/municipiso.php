...
if(isset($_POST["pais"])){
    ...
    // Definir los estado en un array     
    $paisArr = array( 
        "Pais" => array("Selecciona Pais","Mexico"));
     
    
    foreach($paisArr[$pais] as $value){
...
California Sur","Campeche","Chiapas","Chihuahua","Coahuila","Colima","Ciudad de Mexico","Durango","Estado de Mexico","Guanajuato","Guerrero","Hidalgo","Jalisco","Michoacan","Morelos","Nayarit","Nuevo LeÃ³n","Oaxaca","Puebla","QuerÃ©taro","Quintana Roo","San
...
if(isset($_POST["municipios"])){
    // Selccion de Municipios
    $municipios = $_POST["municipios"];
     
    // Definiendo el arreglo de estdos por municipio array
    $municipiosARR = array(
