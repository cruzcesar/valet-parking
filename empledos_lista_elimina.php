...
<body class="do-nicescrol">
      ...
      <div class="container-fluid">
         <div class="row">
            ...
            <div class="col-md-5">
               ...
               <i class="fas fa-undo-alt" style="font-size:22px; position:relative;top:1px;left:2px;color:#fff;"></i>
               <span ><a href="empleados.php?operaciones=baja_empleado" style="font-weight:800;font-size:18px; color:#fff;margin-left:10px; text-decoration:none;"> Seccion anterior  </a></span>
                  <a href="" style="color:#fff; text-decoration: none;"> <i class="fa fa-users" style="font-size:20px; color:#fff;margin-left:25px;"></i>
                  <span style="font-size: 17px; position:relative;left:5px;top:-1px;font-weight:800;">
                  <?php echo $turnos; ?>
                  </span>    
  ...
  <tbody style="background:#fff;">
    ...
    <tr>
      ...
      <td><a href="elimnas_emples.php?turnos=<?php echo $turno_uno_edit; ?>"> <i class="fas fa-user-minus" style="font-size:25px;color:#6d7fcc;"></i> </a></td>
    </tr>
...
<?php  }?>
  ...
  <tbody style="background:#fff;">
    ...
    <tr>
      ...
      <td><?php echo $row['turno'] ?></td>
      <td><?php echo $row['area'] ?></td>
      <td><a href="elimnas_emples.php?turnos=<?php echo $turno_dos_edit ?>"> <i class="fas fa-user-minus" style="font-size:25px;color:#6d7fcc;"></i> </a></td>
    </tr>
...
<?php  }?>
      ...
      <div class="container-fluid">
         <div class="row">
            ...
            <div class="col-md-5">
               ...
               <ul>
               <li style="display:inline-block;">
                  <a href="empleados.php?operaciones=baja_empleado" style="color:#fff; text-decoration: none;"> <i class="fa fa-home" style="font-size:25px; color:#fff;"></i>
                  <span style="font-size: 17px; font-weight:800; position:relative;left:15px;">
                  Ir al Panel
                  </span>    
                  </a>
  ...
  <tbody style="background:#fff;">
    ...
    <tr>
      ...
      <td><?php echo $row['turno'] ?></td>
      <td><?php echo $row['area'] ?></td>
      <td><a href="elimnas_emples.php?turnos=<?php echo $tercer_turno_edit ?>"> <i class="fas fa-user-minus" style="font-size:25px;color:#6d7fcc;"></i> </a></td>
    </tr>
      ...
      <div class="container-fluid">
         <div class="row">
            ...
            <div class="col-md-5">
               ...
               <i class="fas fa-undo-alt" style="font-size:22px; position:relative;top:1px;left:2px;color:#fff;"></i>
               <span ><a href="empleados.php?operaciones=cambiras" style="font-weight:800;font-size:18px; color:#fff;margin-left:10px; text-decoration:none;"> Seccion anterior  </a></span>
                  <a href="" style="color:#fff; text-decoration: none;"> <i class="fa fa-users" style="font-size:20px; color:#fff;margin-left:25px;"></i>
                  <span style="font-size: 17px; position:relative;left:5px;top:-1px;font-weight:800;">
                  <?php echo $turnos; ?>
                  </span>    
