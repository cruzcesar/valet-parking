      ...
      <div class="container-fluid">
         <div class="row">
            ...
            <div class="col-md-5">
               ...
               <span ><a href="menu.php?opcion=tareas" style="font-weight:800;font-size:18px; color:#fff;margin-left:10px; text-decoration:none;"> Seccion anterior  </a></span>
...
<div> aparatdo de chef</div>



  <?php } if($tareas=='cocinero'){ ?>




<div>aparatdo para cocinero</div>
  <?php } if($tareas=='parillero'){ ?>
